...
description: "Promptotyping methodology adapted for academic and professional writing. Four phases applied to text production: structured iteration where documentation and argument logic survive rewrites. Use for research papers, essays, reports, grant proposals, or any writing where source management and argument structure matter."
---
...
**Transition:** "I've inventoried the materials — ready to explore how the argument could work?"
...
**Transition:** "The argument structure is clear enough to document — ready to distill?"
...
Same principle as code Promptotyping: LLM performance degrades with context length. Compress source material into what the LLM actually needs per writing task.
...
**Transition:** "Docs cover the concept, source base, and argument structure. Ready to start writing?"
